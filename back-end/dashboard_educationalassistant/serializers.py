...
from education.models import Major , Department
...
class MajorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Major
        fields = ['major_name', 'major_code', 'department', 'number_of_credits', 'level'
                  , 'education_group']
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Student
        fields = ['user', 'entry_semester', 'gpa', 'entry_year', 'major'
