    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True,
                 null=True, upload_to='accounts/profile_images/')),
                ('phone', models.CharField(blank=True, max_length=15,
                 validators=[accounts.validators.PhoneValidator()])),
                ('address', models.TextField(blank=True, null=True)),
                ('gender', models.CharField(choices=[
                 ('M', 'Male'), ('F', 'Female'), ('MF', 'Unset')], default='MF', max_length=2)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.CharField(choices=[('I', 'Instructor'), ('ASP', 'Assistant Professor'), (
                    'ACP', 'Associate Professor'), ('P', 'Professor')], default='I', max_length=3)),
