...
class Command:
    ...
    def generate_random_name():
        return ''.join(random.choices('abcdefghijklmnopqrstuvwxyz', k=5)).capitalize()
    ...
    def handle(*args, **options):
        ...
        user_data = [
            {'username': Command.generate_random_username(), 'first_name': Command.generate_random_name(), 
             'last_name': Command.generate_random_name(), 'email': Command.generate_random_email()}
            for _ in range(100)
        ]
