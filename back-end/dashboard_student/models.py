...
class SemesterRegistrationRequest(
        models.Model, BaseStudentRegistrationRequest):
...
class AddRemoveRequest(models.Model, BaseStudentRegistrationRequest):
    removed_courses = models.ManyToManyField(
        StudentCourse, related_name='removed_courses')
    added_courses = models.ManyToManyField(
        SemesterCourse, related_name='added_courses')
...
class StudentDeleteSemesterRequest(
        models.Model, BaseStudentRegistrationRequest):
