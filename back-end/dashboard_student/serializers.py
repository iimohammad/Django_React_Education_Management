...
from education.models import (Course, Department, Semester, SemesterClass,
                              SemesterCourse, StudentCourse)
...
class EducationalAssistantEnrollmentRequestSerializer(
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    corequisite = serializers.PrimaryKeyRelatedField(
        many=True, queryset=Course.objects.all())

    class Meta:
        model = Course
        fields = ['course_name', 'course_code',
                  'credit_num', 'prerequisite', 'corequisite']
