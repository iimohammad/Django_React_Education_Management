# Generated by Django 4.2 on 2024-04-12 07:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_status', models.CharField(choices=[('A', 'Registered'), ('R', 'Reserved'), ('C', 'NeedChange'), ('P', 'Approved'), ('D', 'DeletedSemester')], max_length=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('added_courses', models.ManyToManyField(blank=True, related_name='added_courses', to='education.semestercourse')),
                ('removed_courses', models.ManyToManyField(blank=True, related_name='removed_courses', to='education.semestercourse')),
                ('semester_registration_request', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='dashboard_student.semesterregistrationrequest')),
            ],
        ),
    ]
