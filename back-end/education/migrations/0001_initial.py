    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('saturday', 'Saturday'), ('sunday', 'Sunday'), ('monday', 'Monday'), ('tuesday', 'Tuesday'), (
                    'wednesday', 'Wednesday'), ('thursday', 'Thursday'), ('friday', 'Friday')], max_length=20, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Department',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester_type', models.CharField(choices=[
                 ('F', 'Fall'), ('W', 'Winter'), ('S', 'Summer')], default='F', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='SemesterCourse',
            fields=[
                ...
                ('course', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='education.course')),
                ('instructor', models.ForeignKey(
                    on_delete=django.db.models.deletion.PROTECT, to='accounts.teacher')),
                ('semester', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='education.semester')),
            ],
        ),
        migrations.CreateModel(
            name='StudentCourse',
            fields=[
                ...
                ('status', models.CharField(choices=[
                 ('R', 'Registered'), ('P', 'Pending'), ('W', 'Withdrawn')], default='R', max_length=1)),
                ('score', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=5, null=True)),
                ('semester_course', models.ForeignKey(
                    on_delete=django.db.models.deletion.PROTECT, to='education.semestercourse')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='unit_selection', to='education.semester')),
            ],
        ),
        migrations.CreateModel(
            name='SemesterExam',
            fields=[
                ...
                ('semester', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE, related_name='exam', to='education.semester')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='emergency', to='education.semester')),
            ],
        ),
        migrations.CreateModel(
            name='SemesterClass',
            fields=[
                ...
                ('semester', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='classes', to='education.semester')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='addremove', to='education.semester')),
            ],
        ),
        migrations.CreateModel(
            name='Requisite',
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='requisites', to='education.course')),
                ('requisite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='required_with', to='education.course')),
            ],
        ),
        migrations.CreateModel(
            name='Prerequisite',
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='prerequisites', to='education.course')),
                ('prerequisite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='required_by', to='education.course')),
            ],
        ),
        migrations.CreateModel(
            name='Major',
            fields=[
                ...
                ('level', models.CharField(choices=[
                 ('B', 'Bachelor'), ('M', 'Master'), ('P', 'PhD')], default='B', max_length=1)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to='education.department'),
        ),
        migrations.AddField(
            model_name='course',
            name='major',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='education.major'),
        ),
    ]
